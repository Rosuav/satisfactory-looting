...
mapping parse_savefile_data(Stdio.Buffer data, mapping|void options) {
	...
	if (mode == 0) { //New save file, starting in 1.2.0
	...
	//mode should now be nonzero. No idea what it means. It *seems* to be one more than the number of level grouping
	//grids. Maybe a coincidence (law of small numbers and all).
